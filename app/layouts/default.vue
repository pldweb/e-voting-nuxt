...
const sidebarItems = computed(() => {
  ...
  // Admin links for superadmin & verifikator
...
const bottomItems = computed(() => [
  { label: 'Profil', icon: 'lucide:user', to: '/profil' },
])
  ...
  <div class="flex min-h-screen bg-gray-50 dark:bg-gray-950">
    ...
    >
      ...
      <div class="flex h-16 items-center gap-3 border-b dark:border-gray-800 px-6">
        ...
        <div>
          <p class="text-sm font-bold text-gray-900 dark:text-gray-100">e-Voting</p>
          <p class="text-[10px] text-gray-500 dark:text-gray-400">Digital Indonesia</p>
        </div>
      </div>
      ...
      <div class="absolute bottom-0 left-0 right-0 border-t dark:border-gray-800 p-4">
        <div class="flex items-center gap-3">
          <NuxtLink to="/profil" class="flex items-center gap-3 flex-1 min-w-0 hover:opacity-80">
            <div class="flex size-9 items-center justify-center rounded-full bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300 text-sm font-bold shrink-0">
          ...
          <button
            class="rounded-lg p-1.5 text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-600 dark:hover:text-gray-300"
            title="Keluar"
            @click="auth.logout()"
          >
    ...
    <div class="flex-1 lg:ml-64">
      ...
      <header class="sticky top-0 z-30 flex h-14 items-center gap-4 border-b dark:border-gray-800 bg-white dark:bg-gray-900 px-4 lg:hidden">
        ...
        <span class="text-sm font-semibold text-gray-900 dark:text-gray-100">e-Voting</span>
      </header>
